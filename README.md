...
[![Build Status](https://travis-ci.org/ccinelli/jsQR.svg?branch=master)](https://travis-ci.org/ccinelli/jsQR)

A pure javascript QR code reading library.
This library takes in raw images and will locate, extract and parse any QR code found within.

[Demo](https://ccinelli.github.io/jsQR)
...
- Source hosted at [GitHub](https://github.com/ccinelli/jsQR)
- Report issues, questions, feature requests on [GitHub Issues](https://github.com/ccinelli/jsQR/issues) or on [original repo GitHub Issues](https://github.com/cozmo/jsQR/issues)
